...
public class U2L06 extends GenBase {
	
	public U2L06(GenMeta genMeta) {
		super(genMeta);
	}
    ...
    public StringWriter generate(StringWriter stringWriter) {
        ...
        this.context.put("nine", Names.randomName().toLowerCase());
        this.context.put("ten", Names.randomName().toLowerCase());
        this.context.put("eleven", Names.randomName().toLowerCase());
